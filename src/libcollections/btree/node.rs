...
impl<K: Ord, V> Node<K, V> {
    ...
    pub fn search<Sized? Q, NodeRef: Deref<Output=Node<K, V>>>(node: NodeRef, key: &Q)
...
impl<K, V, NodeRef: Deref<Output=Node<K, V>>, Type, NodeType> Handle<NodeRef, Type, NodeType> {
...
impl<K, V, NodeRef, Type, NodeType> Handle<NodeRef, Type, NodeType> where
    NodeRef: Deref<Output=Node<K, V>> + DerefMut,
{
...
impl<K, V, NodeRef: Deref<Output=Node<K, V>>> Handle<NodeRef, handle::Edge, handle::Internal> {
...
impl<K, V, NodeRef: Deref<Output=Node<K, V>>, Type> Handle<NodeRef, Type, handle::LeafOrInternal> {
...
impl<'a, K: 'a, V: 'a, NodeRef: Deref<Output=Node<K, V>> + 'a, NodeType> Handle<NodeRef, handle::KV,
                                                                         NodeType> {
...
impl<'a, K: 'a, V: 'a, NodeRef, NodeType> Handle<NodeRef, handle::KV, NodeType> where
    NodeRef: 'a + Deref<Output=Node<K, V>> + DerefMut,
{

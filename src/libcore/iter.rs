...
#[unstable = "trait is unstable"]
impl<A: Clone, D: Deref<Output=A>, I: Iterator<D>> IteratorCloneExt<A> for I {
...
impl<A: Clone, D: Deref<Output=A>, I: Iterator<D>> Iterator<A> for Cloned<I> {
    fn next(&mut self) -> Option<A> {
        self.it.next().cloned()
    }
...
impl<A: Clone, D: Deref<Output=A>, I: DoubleEndedIterator<D>>
...
#[unstable = "trait is unstable"]
impl<A: Clone, D: Deref<Output=A>, I: ExactSizeIterator<D>> ExactSizeIterator<A> for Cloned<I> {}

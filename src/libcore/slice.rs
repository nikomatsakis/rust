...
trait SplitsIter: DoubleEndedIterator {
...
#[experimental = "needs review"]
impl<'a, T, P> Iterator for Splits<'a, T, P> where P: FnMut(&T) -> bool {
    type Item = &'a [T];
...
#[experimental = "needs review"]
impl<'a, T, P> DoubleEndedIterator for Splits<'a, T, P> where P: FnMut(&T) -> bool {
    #[inline]
...
impl<'a, T, P> SplitsIter for Splits<'a, T, P> where P: FnMut(&T) -> bool {
    #[inline]
...
impl<'a, T, P> SplitsIter for MutSplits<'a, T, P> where P: FnMut(&T) -> bool {
    #[inline]
...
#[experimental = "needs review"]
impl<'a, T, P> Iterator for MutSplits<'a, T, P> where P: FnMut(&T) -> bool {
    type Item = &'a mut [T];
...
#[experimental = "needs review"]
impl<'a, T, P> DoubleEndedIterator for MutSplits<'a, T, P> where
    P: FnMut(&T) -> bool,
{
    #[inline]
...
#[experimental = "needs review"]
impl<I: SplitsIter> Iterator for SplitsN<I> {
...
#[experimental = "needs review"]
impl<'a, T> Iterator for MutChunks<'a, T> {
    type Item = &'a mut [T];
...
#[experimental = "needs review"]
impl<'a, T> DoubleEndedIterator for MutChunks<'a, T> {
    #[inline]
    fn next_back(&mut self) -> Option<&'a mut [T]> {
        if self.v.len() == 0 {
            None

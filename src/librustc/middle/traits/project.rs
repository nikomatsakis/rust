...
enum ProjectionTyCandidate<'tcx> {
    ...
    UnboxedClosure(ast::DefId, Substs<'tcx>),
    FnPointer(Ty<'tcx>),
}
    ...
    -> Result<(), SelectionError<'tcx>>
{
    ...
    match vtable {
        ...
        super::VtableUnboxedClosure(closure_def_id, substs) => {
            candidate_set.vec.push(
                ProjectionTyCandidate::UnboxedClosure(closure_def_id, substs));
        }
    ...
    -> (Ty<'tcx>, Vec<PredicateObligation<'tcx>>)
{
    ...
    match candidate {
        ...
        ProjectionTyCandidate::UnboxedClosure(def_id, substs) => {
            confirm_unboxed_closure_candidate(selcx, obligation, def_id, &substs)
        }
    ...
    -> (Ty<'tcx>, Vec<PredicateObligation<'tcx>>)
{
    ...
    confirm_closure_candidate(selcx, obligation, sig, util::TupleArgumentsFlag::Yes)
}

fn confirm_unboxed_closure_candidate<'cx,'tcx>(
    selcx: &mut SelectionContext<'cx,'tcx>,
    obligation: &ProjectionTyObligation<'tcx>,
    ...
    -> (Ty<'tcx>, Vec<PredicateObligation<'tcx>>)
{
    ...
    confirm_closure_candidate(selcx, obligation, &closure_type.sig, util::TupleArgumentsFlag::No)
}
...
impl<'tcx> Repr<'tcx> for ProjectionTyCandidate<'tcx> {
    fn repr(&self, tcx: &ty::ctxt<'tcx>) -> String {
        match *self {
            ...
            ProjectionTyCandidate::UnboxedClosure(ref a, ref b) =>
                format!("UnboxedClosure(({},{}))", a.repr(tcx), b.repr(tcx)),

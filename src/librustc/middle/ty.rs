...
pub enum AutoRef {
    ...
    /// Convert from ~[]/&[] to &'a &'b [] or str
    AutoBorrowVecRef(/*'a*/ Region, /*'b*/ Region, ast::Mutability),
                    ...
                    match adj.autoref {
                        ...
                        Some(ref autoref) => {
                            match *autoref {
                                ...
                                AutoBorrowVecRef(r_ptr, r_vec, m) => {
...
impl AutoRef {
    pub fn map_region(&self, f: |Region| -> Region) -> AutoRef {
        match *self {
            ...
            ty::AutoBorrowVecRef(r1, r2, m) => ty::AutoBorrowVecRef(f(r1), f(r2), m),

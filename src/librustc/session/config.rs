...
options! {DebuggingOptions, DebuggingSetter, basic_debugging_options,
    ...
    polymorphize: Option<usize> = (None, parse_opt_uint, [TRACKED],
        "enable the experimental polymorphization analysis"),
    polymorphize_dump: bool = (false, parse_bool, [TRACKED],
        "dump results from experimental polymorphization analysis"),
    polymorphize_duplicates: bool = (false, parse_bool, [TRACKED],
        "dump duplicates from experimental polymorphization analysis"),

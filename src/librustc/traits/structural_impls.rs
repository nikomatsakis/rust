...
BraceStructTypeFoldableImpl! {
    impl<'tcx, O> TypeFoldable<'tcx> for traits::Obligation<'tcx, O> {
        cause, recursion_depth, predicate, param_env
...
EnumTypeFoldableImpl! {
    impl<'tcx> TypeFoldable<'tcx> for traits::ObligationCauseCode<'tcx> {
        ...
        (super::ConstSized),
        (super::SharedStatic),
        (super::BlockTailExpression)(a),
        (super::CompareImplMethodObligation) { item_name, impl_item_def_id, trait_item_def_id },
        (super::ProjectionWf)(proj),
        (super::ReferenceOutlivesReferent)(ty),
        (super::ObjectTypeBound)(ty, r),
        (super::ObjectCastObligation)(ty),
        (super::BuiltinDerivedObligation)(cause),
        (super::ImplDerivedObligation)(cause),
    }
}

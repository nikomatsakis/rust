...
impl<K:UnifyKey> VarValue<K> {
    ...
    fn add_child(self, child: K, rank: u32, value: K::Value) -> VarValue<K> {
        VarValue { child: child, rank: rank, value: value, ..self }
    }
...
impl<K:UnifyKey> UnificationTable<K> {
    ...
    fn redirect_root(&mut self,
        ...
        self.set(new_root_key, new_root.add_child(old_root_key, new_rank, new_value));
    }
}

...
use rustc_middle::ty::{
    self, FnSig, Lift, ParamEnv, ParamEnvAnd, PolyFnSig, Predicate, ToPredicate, Ty, TyCtxt, TypeFoldable,
    Variance,
};
...
impl AscribeUserTypeCx<'me, 'tcx> {
    ...
    fn relate_mir_and_user_ty(
        ...
        if let Some(UserSelfTy { impl_def_id, self_ty }) = user_self_ty {
            ...
            self.prove_predicate(ty::PredicateKind::WellFormed(impl_self_ty).to_predicate(self.tcx()));
        }

...
impl<'a, 'tcx> Implicator<'a, 'tcx> {
        ...
        where T : TypeFoldable<'tcx> + ty::HasProjectionTypes + Clone + Repr<'tcx>
    {
        ...
        match value {
            Ok(value) => Ok(value),
            Err(errors) => {
                // TODO I don't like reporting these errors here,
                // but I don't know where else to report them just
                // now. And I don't really expect errors to arise
                // here frequently. Let's ponder this!

...
//    let mut explicit_predicates = FxHashMap();
//
//    {
//        let mut visitor = ExplicitVisitor {
//            tcx,
//            &mut explicit_predicates,
//            crate_num,
//        };
...
//
//
//pub struct ExplicitVisitor<'tcx, 'a> {
//    tcx: TyCtxt<'tcx, 'tcx, 'tcx>,
//    explicit_predicates: &'a FxHashMap<DefId, Vec<String>>,
//    crate_num: CrateNum,
//}
//
//impl<'tcx, 'a, 'v> ItemLikeVisitor<'v> for ExplicitVisitor<'tcx, 'a> {
...
//        //    .filter_map(is_outlives_predicate<'tcx>).collect();
...
//}
//
//fn is_outlives_predicate<'tcx>(pred: ty::Predicate<'tcx>) -> bool {
//    match *pred {

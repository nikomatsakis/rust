...
impl<K, V, M: Deref<Output=RawTable<K, V>>> Bucket<K, V, M> {
...
impl<K, V, M: Deref<Output=RawTable<K, V>>> EmptyBucket<K, V, M> {
    #[inline]
...
impl<K, V, M: Deref<Output=RawTable<K, V>> + DerefMut> EmptyBucket<K, V, M> {
...
impl<K, V, M: Deref<Output=RawTable<K, V>>> FullBucket<K, V, M> {
    #[inline]
    pub fn next(self) -> Bucket<K, V, M> {
        let mut bucket = self.into_bucket();
        bucket.next();
...
impl<K, V, M: Deref<Output=RawTable<K, V>> + DerefMut> FullBucket<K, V, M> {
...
impl<'t, K, V, M: Deref<Output=RawTable<K, V>> + 't> FullBucket<K, V, M> {
...
impl<'t, K, V, M: Deref<Output=RawTable<K, V>> + DerefMut + 't> FullBucket<K, V, M> {
...
impl<K, V, M: Deref<Output=RawTable<K, V>>> GapThenFull<K, V, M> {
    #[inline]
